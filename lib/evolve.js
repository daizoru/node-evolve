...
(function() {
  var P, async, clone, copy, cs2js, deck, fs, inspect, isArray, isBoolean, isFunction, isNumber, isString, isUndefined, js2cs, jsp, main, makeRules, mutable, mutate, mutateSync, pretty, pro, readFile, toAST,
  ...
  exports.clone = clone = function(opts) {
    ...
    mutateBranch = function(branch) {
      var clipboard, locals, rules, transform, _j, _ref;
      locals = {
        callables: [],
        readables: [],
        writables: []
    ...
    mutateTree = function(tree) {
      ...
      (searchInline = function(node) {
        var n, _j, _k, _len1, _len2, _ref, _results, _results1;
        if (isArray(node)) {
          found = false;
          if (node[0] === 'call') {
            console.log("WHAT: " + pretty(node));
            if ((_ref = "" + node[1]) === 'dot,name,evolve,inline' || _ref === 'name,inline') {
  ...
  exports.cli = main = function() {
    var a, args, config, debug, encoding, file, iterations, nb_args, ratio, _i, _len;
    args = process.argv;
    nb_args = args.length;
    file = args[2];
